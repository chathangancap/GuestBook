		...
		<div class="row"> 
			<div class="col-md-12"> 
				...
				<div class="panel panel-primary"> 
					...
					ResultSet rs = con.chonDuLieuTuDTB("select * from GuestBook");
					...
					<table class="table table-hover" id="dev-table"> 
						...
						<tr> 
							...
							<td><a href="XoaTK?stt=<%=rs.getString(1)%>"><button class="btn btn-warning">Xóa</button></a></td>
							<td><a href="SuaTaiKhoan.jsp?stt=<%=rs.getString(1)%>"><button class="btn btn-primary">Sửa</button></a></td>
						</tr> 
						<%
						}
						%>
